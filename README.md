...
### 🚀 Em construção
- Projetos de Machine Learning com dados reais
- Pipelines de ETL com SQL e Python
- Criação de ABTs para análise preditiva
- Estudos de AutoML e Clustering
...
> "A Física me ensinou a investigar, a programação me ensinou a construir. A Ciência de Dados é onde essas duas forças se encontram." – Fabio Medeiros
